...
<body>
    <form method="post" action="update.php">
        <table align="center">
            ...
            <tr>
                <td>密碼：<input type="text" name="new_password" value="<? echo $rs[1] ?>"></td>
            </tr>
            <tr>
...
<?
    ...
    $newemail = @$_POST['new_email'];
        $sql = "update account a_id = $newaccount, password = $newpass, name = $newname, level = $newlevel, email=$newemail where a_id =" .$_GET['a_id'];
